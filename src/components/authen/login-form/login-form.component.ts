...
@Component({
  ...
  template: `
    ...
    <p class="description-auth">Application de pronostics sportifs spécialisée dans le tennis, le football et le basketball</p>
    <div class="bloc-login-form">
      ...
      <!-- <div class="link-fb">
         <button
          ...
          <div class="version"><label>V 3.0.2</label></div>
        </div>
`,
